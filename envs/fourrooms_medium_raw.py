...
class FourRoomsCustomEnv(MiniGridEnv):
    ...
    def __init__(self, agent_pos=None, goal_pos=None):
        ...
        super().__init__(width=11,height=11, max_steps=100, agent_view_size=7,see_through_walls=False,)
...
class FourroomsMediumRaw(gym.Env):
    def __init__(self):
        self.env = FourRoomsCustomEnv()
        self.tile_size = 1
    ...
    def step(self, action):
        ...
        #     print("*"*10,"catch error","*"*10)
        #     print(self.last_state, action)
